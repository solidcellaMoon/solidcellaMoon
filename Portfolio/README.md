...
* [게임 개발 포트폴리오](./files/게임%20개발%20포트폴리오.pdf){:target="_blank"}

- [SW 개발 포트폴리오](./files/프로그래밍%20포트폴리오.pdf){:target="_blank"}
...
- [[게임] 2D 모바일 게임 리팩토링](#2D-모바일-게임-리팩토링) (`2021.03` ~ `2021.04`)

* [[게임] 2D 스토리텔링 게임](#2D-스토리텔링-게임) (`2020.10` ~ `2020.12`)
* [[해커톤] 2D 플랫포머 게임](#2D-플랫포머-게임) (`2020.11` ~ `2020.11`)
* [[해커톤] API 활용 모바일 어플리케이션](#API-활용-모바일-어플리케이션) (`2020.10` ~ `2020.10`)
* [[전공] 클라우드 컴퓨팅 및 프로그래밍](#클라우드-컴퓨팅-및-프로그래밍) (`2020.09` ~ `2020.12`)
* [[전공] 다양한 기술스택을 활용한 웹사이트 개발](#다양한-기술스택을-활용한-웹사이트-개발) (`2020.09` ~ `2020.12`)
* [[졸업작품] 자연어 처리와 기계학습을 통한 우울 감정 분석과 인식](#자연어-처리와-기계학습을-통한-우울-감정-분석과-인식) (`2019.07` ~ `2020.06`)
* [[게임] 2D 경영 시뮬레이션 모바일 게임](#2D-경영-시뮬레이션-모바일-게임) (`2019.05` ~ `2019.08`)
...
- 사용 언어: `C#`
- GameManager를 통해 난이도 개편 및 오류 수정
...
* Github 저장소: [[클릭]](https://github.com/solidcellaMoon/GodBird)
* 프로토타입 홍보 영상: [[클릭]](https://youtu.be/o3lrRYedrtE)
